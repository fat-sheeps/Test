...
public class HttpController1 {
    ...
    public static class MyHystrixCommand extends HystrixCommand<String> {
        ...
        protected String run() throws InterruptedException {
            ...
            String a = "";
            for (int i = 0; i < 100; i++) {
                a += "qwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbnm";
            }
//            HttpUtil.doPost("http://localhost:8888/server?time=" + t,null);
    ...
    public Object hystrix(int num) {
        ...
        for (int i = 1; i <= num; i++) {
            ...
            int t = RandomUtil.randomInt(1, 100);
            try {
                totals ++;
