...
//        String result3 = doPost("http://localhost:8888/server", null);
        ...
        HttpPost httpPost = new HttpPost("http://whois.pconline.com.cn/ipJson.jsp?ip=36.152.29.242&json=true");
        httpPost.setConfig(requestConfigBuilder.setSocketTimeout(1000).build());
        ...
        ResponseHandler<byte[]> responseHandler = httpResponse -> {
            ...
            log.info("httpResponse: Headers:{}", httpResponse.getAllHeaders());
            return EntityUtils.toByteArray(httpResponse.getEntity());
        };
        byte[] result = httpClientDsp.execute(httpPost, responseHandler);
